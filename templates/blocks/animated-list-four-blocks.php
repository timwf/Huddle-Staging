...
<section class="sports-animated-list">
        <div class="sports-animated-list__inner container">
          <div class="sports-animated-list__left">
            <svg id="sports-svg" xmlns="http://www.w3.org/2000/svg" width="290.25" height="1143" viewBox="0 0 290.25 1114">
              ...
              <g id="Group_83" data-name="Group 83" transform="translate(-255.375 -279)">
                ...
                <circle class="sports-element-svg--dot" id="Ellipse_11" data-name="Ellipse 11" cx="7" cy="7" r="7" transform="translate(388.5 404)" fill="white"></circle>
                <circle class="sports-element-svg" id="inactive-three" data-name="Ellipse 14" cx="17" cy="17" r="17" transform="translate(378.5 395)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></circle>
                <circle class="sports-element-svg--dot" id="Ellipse_11" data-name="Ellipse 11" cx="7" cy="7" r="7" transform="translate(388.5 1244)" fill="white"></circle>
                <path class="sports-element-svg--arrow" id="solid-line-one--arrow" transform="translate(0 560)" data-name="Path 20" d="M412.5,642.668l-17,17-17-17" fill="none" stroke="#0a1c2b" stroke-miterlimit="10" stroke-width="1"></path>
                ...
                <path class="sports-element-svg--arrow" id="curve-left--arrow-4" transform="translate(0 -1118)" data-name="Path 22" d="M339.7,1816.508l20.968-11.761-11.761-20.968" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></path>
                ...
                <line class="sports-element-svg" id="solid-line-one" data-name="Line 62" y2="193.336" transform="translate(395.5 1010)" fill="none" stroke="#0a1c2b" stroke-miterlimit="10" stroke-width="1"></line>
                <line class="sports-element-svg" id="dotted-end" data-name="Line 65" y2="101.004" transform="translate(395.5 1296)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1" stroke-dasharray="8"></line>
                <path class="curve-left" id="curve-left-4" data-name="Path 25" d="M339.7,1797.663a139.676,139.676,0,0,1,20.969-263.273" transform="translate(0 -1118)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1" stroke-dasharray="8"></path>
