<?php 
  ...
  $six = get_field('block_six');
  $seven = get_field('block_seven');
?>

<section class="sports-animated-list">
  <div class="sports-animated-list__inner container">
    <div class="sports-animated-list__left">
      <svg id="sports-svg" xmlns="http://www.w3.org/2000/svg" width="290.25" height="2036" viewBox="0 0 290.25 2018">
        ...
        <g id="Group_83" data-name="Group 83" transform="translate(-255.375 -279)">
          ...
          <circle class="sports-element-svg" id="inactive-three" data-name="Ellipse 101" cx="17" cy="17" r="17" transform="translate(378.5 2091)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></circle>
          <circle class="sports-element-svg--dot" id="Ellipse_11" data-name="Ellipse 102" cx="7" cy="7" r="7" transform="translate(388.5 2101)" fill="white"></circle>
          <circle class="sports-element-svg" id="inactive-three" data-name="Ellipse 103" cx="17" cy="17" r="17" transform="translate(378.5 1802)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></circle>
          <circle class="sports-element-svg--dot" id="Ellipse_11" data-name="Ellipse 104" cx="7" cy="7" r="7" transform="translate(388.5 1813)" fill="white"></circle>
          ...
          <path class="sports-element-svg--arrow" id="curve-right--arrow" data-name="Path arrow" transform="translate(0 1130)" d="M451.3,980.237,430.33,968.476l11.761-20.969" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></path>
          ...
          <path class="sports-element-svg--arrow" id="curve-left--arrow" transform="translate(0 4)" data-name="Path 22" d="M339.7,1816.508l20.968-11.761-11.761-20.968" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></path>
          ...
          <line class="sports-element-svg" id="dotted-end" data-name="Line 65" y2="101.004" transform="translate(395.5 2147)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1" stroke-dasharray="8"></line>
          ...
          <path class="curve-left" id="curve-left" data-name="Path 25" d="M339.7,1797.663a139.676,139.676,0,0,1,20.969-263.273" transform="translate(0 3)" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1" stroke-dasharray="8"></path>
          <path class="curve-right" id="curve-right" transform="translate(0 1130)"  data-name="Path 101" d="M430.332,698.12A139.676,139.676,0,0,1,449,962.374" fill="none" stroke="#ccc" stroke-miterlimit="10" stroke-width="1"></path>
    ...
    <div class="sports-animated-list__right">     
      <div class="sports-animated-list__item-container sports-animated-list__item-container--inactive">
          ...
          <a href="<?php echo $two['button']['button_link']['url'] ?>">
            ...
            <div class="sports-animated-list__item-container sports-animated-list__item-container--inactive">
            <a href="<?php echo $six['button']['button_link']['url'] ?>">
            <?php _get_template_part('templates/components/_resp-img', ['field' => $six['image'], 'sizes' => '(max-width: 1023px) 100vw, 950px']) ?>
            </a> 
              <div class="sports-animated-list__item-text">
              <a href="<?php echo $six['button']['button_link']['url'] ?>"><h1><?php echo $six['title'] ?></h1></a>
                <?php if ($six['button']['button_link']): 
              _get_template_part('templates/components/_button', [
                'copy' => $six['button']['button_copy'],
                'url' => $six['button']['button_link']['url']
              ]); 
            endif; ?>
              </div>
            </div>
            ...
            <div class="sports-animated-list__item-container sports-animated-list__item-container--inactive">
            <a href="<?php echo $seven['button']['button_link']['url'] ?>">
            <?php _get_template_part('templates/components/_resp-img', ['field' => $seven['image'], 'sizes' => '(max-width: 1023px) 100vw, 950px']) ?>
            </a> 
              <div class="sports-animated-list__item-text">
              <a href="<?php echo $seven['button']['button_link']['url'] ?>"><h1><?php echo $seven['title'] ?></h1></a>
                <?php if ($seven['button']['button_link']): 
              _get_template_part('templates/components/_button', [
                'copy' => $seven['button']['button_copy'],
                'url' => $seven['button']['button_link']['url']
              ]); 
            endif; ?>
              </div>
            </div>
